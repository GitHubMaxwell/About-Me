...
alert('Hello ' + guestName + '! Please answer the following 6 questions of my guessing game with a YES or a NO!');
...
function questionThree(){
  ...
  if (answerThree === 'NO') {
    ...
    while (answerThree !== 'NO' || answerThree === 'YES') {
      answerThree = prompt('Try again' + guestName + 'Do I hate pizza?').toUpperCase();
      if (answerThree === 'NO') {
        alert('You\'re absolutely right ' + guestName + '! Who hates pizza that\'s what I want to know!?.');
